...
//			msg.setContent("<a href=\"http://localhost:8080/askdemo/UserServlet?opr=activate&token="+token+"\">点击激活</a>","text/html;charset=utf-8");
			msg.setContent("<a href=\"http://localhost:8080/askdemo/UserServlet?opr=activate&token="+token+"\">点击激活:http://localhost:8080/askdemo/UserServlet?opr=activate&token="+token+"</a>","text/html;charset=utf-8");
//			//发送邮件
			Transport.send(msg);
